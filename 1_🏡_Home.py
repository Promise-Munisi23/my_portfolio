...
# ----------------- info ----------------- #
def gradient(red, orange, yellow, heading1, subheading1):
    st.markdown(f'<h1 style="text-align:center;background-image: linear-gradient(to right,{red}, {orange});font-size:60px;border-radius:2%;">'
                f'<span style="color:{yellow};">{heading1}</span><br>'
                f'<span style="color:white;font-size:17px;">{subheading1}</span></h1>', 
